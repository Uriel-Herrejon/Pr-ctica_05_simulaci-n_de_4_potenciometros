...
l3 = input(prompt);
prompt = 'Introduza la longitud del primer eslabon (l4): ';
l4 = input(prompt);
...
while 1 
    ...
    A4 = dhParameters(0,d4,a4,alpha_4_rad);
    ...
    grid on 
    angdeg_4 = (a(4)-512)*130/512;
    theta4_rad = deg2rad(angdeg_4);
    Rotz = [cos(theta4_rad) -sin(theta4_rad)  0; sin(theta4_rad) cos(theta4_rad) 0; 0 0 1];
    A1 = dhParameters(theta1_rad,d1,a1,alpha_1_rad);
    A2 = dhParameters(theta2_rad,d2,a2,alpha_2_rad);
    A3 = dhParameters(theta3_rad,d3,a3,alpha_3_rad);
